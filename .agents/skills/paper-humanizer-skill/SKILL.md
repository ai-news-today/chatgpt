...
**Scope boundary: This skill is for academic papers and theses only — NOT for general blog posts.**
For blog writing voice and structure, use [blog-seo-content-create](../blog-seo-content-create/SKILL.md) instead.
Use this skill only when: the text is a research paper, thesis, or formal academic submission that requires strict factuality preservation and citation retention during AI-pattern reduction.
